...
<select name="Course__c" required>
  ...
  <option value="MBA Executivo em Liderança e Gestão">MBA Executivo em Liderança e Gestão</option>
</select>

<!-- ou radio -->
<label><input type="radio" name="Course__c" value="SEER" /> SEER</label>
